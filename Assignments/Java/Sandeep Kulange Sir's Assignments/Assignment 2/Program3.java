class Program3 {
    public static void main(String[] args) {
        ...
        // Done with reading the documentation
...
/*Output:
 Bytes used for a byte: 1
Byte Min Value: -128
Byte Max Value: 127
Byte to String: 12
String to Byte: 20
Invalid String to Byte conversion error: java.lang.NumberFormatException: For input string: "ABCD123"
Byte to Wrapper Byte: 12
String to Wrapper Byte: 25
*/
